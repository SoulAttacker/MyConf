;;; init-path.el --- exec path from shell config     -*- lexical-binding: t; -*-

;; Copyright (C) 2023  soulwalker

;; Author: soulwalker <soulwalker@soulwalkerdeMac-Studio.local>
;; Keywords: exec-path-from-shell
...
;; too slow but useful emmm.....
;; (use-package exec-path-from-shell
;;   :demand t
;;   :config
;;   (setq exec-path-from-shell-variables '("GOROOT" "GOPATH"))
