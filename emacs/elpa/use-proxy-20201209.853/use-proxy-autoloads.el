;;; use-proxy-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Toggle proxies globally by set/unset no_proxy key in `url-proxy-services'." t)
